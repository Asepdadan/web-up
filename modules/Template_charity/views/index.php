...
<link href="<?php echo base_url($murl.'views/css/bootstrap.css'); ?>" rel='stylesheet' type='text/css' />
		 ...
		 <div class="mission-sec">
			 <div class="blog-grids">
				 <div class="col-md-6 blog1 text_grid">
                                        <h4><a href="<?php echo base_url('Template_charity/remap/detail'); ?>">Nulla posuere ipsum at commodo viverra.</a></h4>
				 ...
				 <div class="col-md-6 blog-pic">
					  <img src="<?php echo base_url($murl.'views/images/m2.jpg'); ?>" class="img-responsive" alt="">
				 </div>
				 <div class="clearfix"></div>
			 </div>	
			 <div class="blog-grids">
				 <div class="col-md-6 blog-pic">
					  <img src="<?php echo base_url($murl.'views/images/m1.jpg'); ?>" class="img-responsive" alt="">
				 </div>
				 <div class="col-md-6 blog1">
					 <h4><a href="<?php echo base_url('Template_charity/remap/detail'); ?>">Curabitur viverra elit a mollis ultricies.</a></h4>
					 <p>Cras nec neque sed magna bibendum volutpat. Duis bibendum turpis vehicula purus feugiat eleifend Fusce hendrerit elit vitae massa tincidunt accumsanEtiam blandit elit laoreet, malesuada massa quis.</p>
				 </div>			 
				 <div class="clearfix"></div>
			 </div>
			 <div class="blog-grids">
				 <div class="col-md-6 blog1 text_grid">
					 <h4><a href="<?php echo base_url('Template_charity/remap/detail'); ?>">Duis viverra orci et dapibus gravida.</a></h4>
					 <p>Cras nec neque sed magna bibendum volutpat. Duis bibendum turpis vehicula purus feugiat eleifend Fusce hendrerit elit vitae massa tincidunt accumsanEtiam blandit elit laoreet, malesuada massa quis.</p>
				 </div>
				 <div class="col-md-6 blog-pic">
					  <img src="<?php echo base_url($murl.'views/images/m3.jpg'); ?>" class="img-responsive" alt="">
				 </div>
				 <div class="clearfix"></div>
			 </div>
		 </div>
...
<div class="bottom-grids">
	 <div class="container">
		 <div class="col-md-5 bottom-left-grid">
			 ...
			 <div class="project">				 
				 <img src="<?php echo base_url($murl.'views/images/pic.jpg'); ?>" class="img-responsive" alt=""/>
		 ...
		 <div class="col-md-7 bottom-right-grid">
			  ...
			  <div class="event-grids">
					<div class="col-md-5 event-pic">
						 <img src="<?php echo base_url($murl.'views/images/e1.jpg'); ?>" class="img-responsive" alt=""/> 
					</div>
			  ...
			  <div class="event-grids">
					<div class="col-md-5 event-pic">
						 <img src="<?php echo base_url($murl.'views/images/e2.jpg'); ?>" class="img-responsive" alt=""/> 
					</div>
					<div class="col-md-7 event-pic-info">
						 <h4><a href="about.html">Donec cursus felis a enim egestas</a></h4>
						 <span>19th June | 10:00 - 12:00</span>
