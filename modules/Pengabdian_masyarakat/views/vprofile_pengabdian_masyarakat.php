        ...
        <hr>
          ...
          <div id="content">
            <div class="wrap clearFix">
                ...
                <h2>PROFILE PENGABDIAN MASYARAKAT</h2>

                <div class="clearFix">
                    <div class="col floatLeft" style="width: 600px">
                   

<!--                        <img src="img/icon-location.png" alt="" class="icon">-->

                        <h3>DATA PENGABDIAN MASYARAKAT UPPM POLBAN TAHUN 2011- 2015</h3>
            ...
            <div class="floatRight" style="margin-right: 40px">
                    ...
                    <h4>HOME</h4>
                        <ul>
                    <li><a href="<?php echo site_url('');?>">PROFILE PENGABDIAN MASYARAKAT</a></li>
					<li><a href="<?php echo site_url('') ?>">SKEMA PENGABDIAN MASYARAKAT</a></li>
					<li><a href="<?php echo site_url('') ?>">PANDUAN</a></li>
