                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                                ...
                                <?php } ?>
                                    ...
                                    <form action="<?php echo base_url('Skema_penelitian/action_skema_detail') ?>" method="POST" class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="uraian" id="inputUraian" class="form-control" rows="3" placeholder="Uraian tentang skema"></textarea>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php $no = 1;foreach($join as $row) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('Skema_penelitian/hapus_skema_penelitian/'.$row['id']); ?>" class="text-info"><span class="glyphicon glyphicon-trash"></span></a>

                                                    <a href="<?php echo base_url('Skema_penelitian/edit_skema_penelitian/'.$row['id']); ?>" class="text-info"><span class="glyphicon glyphicon-pencil"></span></a>
