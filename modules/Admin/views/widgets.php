			...
			<div id="page-wrapper">
				<div class="graphs">
						...
						<div class="col-md-4 widget_middle_left">
							<div class="online">
								<a href="#"><div class="online-top">
									<div class="top-at">
										<img class="img-responsive" src="<?php echo base_url($murl.'views/images/3.png'); ?>" alt="">
									</div>
									<div class="top-on">
										<div class="top-on1">
								...
								<a href="#"><div class="online-top">
									<div class="top-at">
										<img class="img-responsive" src="<?php echo base_url($murl.'views/images/4.png'); ?>" alt="">
									</div>
									<div class="top-on">
										<div class="top-on1">
								...
								<a href="#"><div class="online-top">
									<div class="top-at">
										<img class="img-responsive" src="<?php echo base_url($murl.'views/images/5.png'); ?>" alt="">
									</div>
									<div class="top-on">
										<div class="top-on1">
								...
								<a href="#"><div class="online-top online-top1">
									<div class="top-at">
										<img class="img-responsive" src="<?php echo base_url($murl.'views/images/1.png'); ?>" alt="">
									</div>
									<div class="top-on">
										<div class="top-on1">
					...
					<script type="text/javascript">
					   ...
					   <script type="text/javascript" src="<?php echo base_url($murl.'views/js/jquery.flexisel.js'); ?>"></script>
					</div>
