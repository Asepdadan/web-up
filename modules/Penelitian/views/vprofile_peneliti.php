...
<!--                        <img src="img/icon-location.png" alt="" class="icon">-->
                        ...
                        <h3>DATA PENELITIAN UPPM POLBAN TAHUN 2011- 2015</h3>
                         <p><img src="<?php echo base_url('images/gambar-peneliti.JPG'); ?>"  alt="Image description" title="Image title" /></p>
                        <p style="text-align: justify">
                            Gambar 1.  Rasio Jumlah Peneliti (Ketua dan Anggota) (%) di Politeknik Negeri Bandung Tahun 2011-2015
Sumber: Diolah dari Data UPPM 2016 <BR>

•	% Rasio jumlah peneliti terbanyak terjadi pada tahun 2012-2015 di Jurusan Teknik Kimia<BR>
•	% Rasio jumlah peneliti di semua jurusan sangat potensial untuk lebih ditingkatkan.
...
<!--                <form action="./" method="post">
            ...
            <div class="floatRight" style="margin-right: 40px">
                    ...
                    <h4>HOME</h4>
                        <ul>
                            <li><a href="<?php echo site_url('Cprofile');?>">PROFILE UPPM</a></li>
					<li><a href="<?php echo site_url('Cprofile/peneliti') ?>">PROFILE PENELITI</a></li>
					<li><a href="<?php echo site_url('Cinfo') ?>">INFO TERBARU</a></li>
