                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" ><span class=" glyphicon glyphicon-list-alt"></span> <?php echo $form_judul; ?> </a></h3>
                            </div>
                        ...
                        <form action="<?php echo site_url('Berita/edit_berita'); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <?php foreach($query as $row){ ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <textarea name="judul"  class="form-control" rows="3" required="required"><?php echo $row['judul']; ?></textarea>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                <textarea name="isi"  class="form-control" rows="3" required="required"><?php echo $row['isi']; ?></textarea>
                                </div>
                             </div>
                            </div>

                             <div class="form-group">
                            <label class="col-md-3">Gambar Berita</label>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <img src="<?php echo base_url('upload/berita/'.$row['gambar_berita']) ?>" class="img-responsive" alt="Image">
                                </div>
                             </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <td rowspan="5"><span class="">Tidak Ada data</span></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
