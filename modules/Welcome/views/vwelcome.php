...
<div id="container">
	...
	<div id="body">
            <ul>
				...
				<li><a href="<?php echo base_url('index.php/Onepage'); ?>">Onepage</a></li>
                <li><a href="<?php echo base_url('ReadBean'); ?>">Read Bean PHP</a></li>
                <li><a href="<?php echo base_url('Template_charity'); ?>">Template_charity</a></li>
                <li><a href="<?php echo base_url('Template_luxus'); ?>">Template_luxus</a></li>
                <li><a href="<?php echo base_url('Template_standard'); ?>">Template_standard</a></li>
                <li><a href="<?php echo base_url('Home'); ?>">Template UPPM</a></li>
            </ul>
	</div>
